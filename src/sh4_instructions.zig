...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    .{ .code = 0b0110000000000010, .mask = 0b0000111111110000, .fn_ = interpreter.movl_atRm_Rn, .name = "mov.l @Rm,Rn", .latency_cycles = 2, .jit_emit_fn = sh4_jit.movl_atRm_Rn },
    ...
    .{ .code = 0b0010000000000010, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atRn, .name = "mov.l Rm,@Rn", .jit_emit_fn = sh4_jit.movl_Rm_atRn },
    ...
    .{ .code = 0b0010000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atDecRc, .name = "mov.l Rm,@-Rn", .jit_emit_fn = sh4_jit.movl_Rm_atRnDec },
    ...
    .{ .code = 0b0001000000000000, .mask = 0b0000111111111111, .fn_ = interpreter.movl_Rm_atDispRn, .name = "mov.l Rm,@(disp,Rn)", .jit_emit_fn = sh4_jit.movl_Rm_atDispRn },
