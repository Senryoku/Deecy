...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    .{ .code = 0b0000000000000010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_SR_Rn, .name = "stc SR,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_SR_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000000011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SR_at_Rn_dec, .name = "stc.l SR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_SR_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000010010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_GBR_Rn, .name = "stc GBR,Rn", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_GBR_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000010011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_GBR_at_Rn_dec, .name = "stc.l GBR,@-Rn", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_GBR_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000100010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_VBR_Rn, .name = "stc VBR,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_VBR_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000100011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_VBR_at_Rn_dec, .name = "stc.l VBR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_VBR_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000111010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_SGR_rn, .name = "stc SGR,Rn", .privileged = true, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.stc_SGR_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000110010, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SGR_at_Rn_dec, .name = "stc.l SGR,@-Rn", .privileged = true, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.stcl_SGR_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000110010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_SSR_rn, .name = "stc SSR,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_SSR_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000110011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SSR_at_Rn_dec, .name = "stc.l SSR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_SSR_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000001000010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_SPC_rn, .name = "stc SPC,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_SPC_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000001000011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SPC_at_Rn_dec, .name = "stc.l SPC,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_SPC_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000011111010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_DBR_rn, .name = "stc DBR,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_DBR_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000011110010, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_DBR_at_Rn_dec, .name = "stc.l DBR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_DBR_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000000010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACH_at_Rn_dec, .name = "sts.l MACH,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stsl_MACH_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000010010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACL_at_Rn_dec, .name = "sts.l MACL,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stsl_MACL_atRnDec, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000101010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_PR_Rn, .name = "sts PR,Rn", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.sts_PR_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000100010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_PR_atRn_dec, .name = "sts.l PR,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stsl_PR_atRnDec, .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
