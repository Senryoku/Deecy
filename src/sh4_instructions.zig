...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    .{ .code = 0b0010000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atDecRn, .name = "mov.l Rm,@-Rn", .jit_emit_fn = sh4_jit.movl_Rm_atRnDec, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0011000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.cmphi_Rm_Rn, .name = "cmp/hi Rm,Rn", .jit_emit_fn = sh4_jit.cmphi_Rm_Rn },
