...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    .{ .code = 0b0000000000001110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_atR0Rm_rn, .name = "mov.l @(R0,Rm),Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .access = .{ .r = .{ .r0 = true, .rm = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0000000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atR0Rn, .name = "mov.l Rm,@(R0,Rn)", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .access = .{ .r = .{ .r0 = true, .rn = true, .rm = true }, .w = .{} } },
    ...
    .{ .code = 0b0110000000001000, .mask = 0b0000111111110000, .fn_ = interpreter.swapb, .name = "swap.b Rm,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .access = .{ .r = .{ .rn = true }, .w = .{ .rm = true } } },
    .{ .code = 0b0110000000001001, .mask = 0b0000111111110000, .fn_ = interpreter.swapw, .name = "swap.w Rm,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .access = .{ .r = .{ .rn = true }, .w = .{ .rm = true } } },
    ...
    .{ .code = 0b0011000000001110, .mask = 0b0000111111110000, .fn_ = interpreter.addc_Rm_Rn, .name = "addc Rm,Rn", .privileged = false, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0011000000001111, .mask = 0b0000111111110000, .fn_ = interpreter.addv_Rm_Rn, .name = "addv Rm,Rn", .privileged = false, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0011000000001000, .mask = 0b0000111111110000, .fn_ = interpreter.sub_Rm_Rn, .name = "sub Rm,Rn", .privileged = false, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0010000000001001, .mask = 0b0000111111110000, .fn_ = interpreter.and_Rm_Rn, .name = "and Rm,Rn", .privileged = false, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b1100100100000000, .mask = 0b0000000011111111, .fn_ = interpreter.and_imm_R0, .name = "and #imm,R0", .privileged = false, .access = .{ .r = .{ .r0 = true }, .w = .{ .r0 = true } } },
    ...
    .{ .code = 0b0110000000000111, .mask = 0b0000111111110000, .fn_ = interpreter.not_Rm_Rn, .name = "not Rm,Rn", .privileged = false, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0010000000001011, .mask = 0b0000111111110000, .fn_ = interpreter.or_Rm_Rn, .name = "or Rm,Rn", .privileged = false, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b1100101100000000, .mask = 0b0000000011111111, .fn_ = interpreter.or_imm_r0, .name = "or #imm,R0", .privileged = false, .access = .{ .r = .{ .r0 = true }, .w = .{ .r0 = true } } },
    ...
    .{ .code = 0b0100000000000000, .mask = 0b0000111100000000, .fn_ = interpreter.shll, .name = "shll Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000001000, .mask = 0b0000111100000000, .fn_ = interpreter.shll2, .name = "shll2 Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000011000, .mask = 0b0000111100000000, .fn_ = interpreter.shll8, .name = "shll8 Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000101000, .mask = 0b0000111100000000, .fn_ = interpreter.shll16, .name = "shll16 Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000000001, .mask = 0b0000111100000000, .fn_ = interpreter.shlr, .name = "shlr Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000001001, .mask = 0b0000111100000000, .fn_ = interpreter.shlr2, .name = "shlr2 Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000011001, .mask = 0b0000111100000000, .fn_ = interpreter.shlr8, .name = "shlr8 Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000101001, .mask = 0b0000111100000000, .fn_ = interpreter.shlr16, .name = "shlr16 Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000001110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_SR, .name = "ldc Rn,SR", .privileged = true, .issue_cycles = 4, .latency_cycles = 4, .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000000111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_at_Rn_inc_SR, .name = "ldc.l @Rn+,SR", .privileged = true, .issue_cycles = 4, .latency_cycles = 4, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0000000001101010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_FPSCR_Rn, .name = "sts FPSCR,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 3, .access = .{ .r = .{ .rn = true }, .w = .{} } },
