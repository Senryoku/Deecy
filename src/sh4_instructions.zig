...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    // FIXME: The jitted version of these instructions breaks Virtual Tennis 2. I have no idea why.
    .{ .code = 0b0010000000000100, .mask = 0b0000111111110000, .fn_ = interpreter.movb_Rm_atDecRn, .name = "mov.b Rm,@-Rn", .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } }, // .jit_emit_fn = sh4_jit.movb_Rm_atDecRn
    .{ .code = 0b0010000000000101, .mask = 0b0000111111110000, .fn_ = interpreter.movw_Rm_atDecRn, .name = "mov.w Rm,@-Rn", .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } }, // .jit_emit_fn = sh4_jit.movw_Rm_atDecRn
    .{ .code = 0b0010000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atDecRn, .name = "mov.l Rm,@-Rn", .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } }, // .jit_emit_fn = sh4_jit.movl_Rm_atDecRn
