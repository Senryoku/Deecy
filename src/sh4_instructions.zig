...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    .{ .code = 0b0100000000000111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_at_Rn_inc_SR, .name = "ldc.l @Rn+,SR", .privileged = true, .issue_cycles = 4, .latency_cycles = 4, .jit_emit_fn = sh4_jit.ldcl_atRnInc_SR, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000010111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_at_Rn_inc_GBR, .name = "ldc.l @Rn+,GBR", .privileged = false, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000100111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_at_Rn_inc_VBR, .name = "ldc.l @Rn+,VBR", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("vbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000110111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_at_Rn_inc_SSR, .name = "ldc.l @Rn+,SSR", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("ssr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000001000111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_at_Rn_inc_SPC, .name = "ldc.l @Rn+,SPC", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("spc"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000011110110, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_at_Rn_inc_DBR, .name = "ldc.l @Rn+,DBR", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("dbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000000110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_at_Rn_inc_MACH, .name = "lds.l @Rn+,MACH", .privileged = false, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("mach"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000010110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_at_Rn_inc_MACL, .name = "lds.l @Rn+,MACL", .privileged = false, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("macl"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000100110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRn_inc_PR, .name = "lds.l @Rn+,PR", .privileged = false, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("pr"), .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000000011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SR_at_Rn_dec, .name = "stc.l SR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("sr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000010011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_GBR_at_Rn_dec, .name = "stc.l GBR,@-Rn", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000100011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_VBR_at_Rn_dec, .name = "stc.l VBR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("vbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000110010, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SGR_at_Rn_dec, .name = "stc.l SGR,@-Rn", .privileged = true, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("sgr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000110011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SSR_at_Rn_dec, .name = "stc.l SSR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("ssr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000001000011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SPC_at_Rn_dec, .name = "stc.l SPC,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("spc"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000011110010, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_DBR_at_Rn_dec, .name = "stc.l DBR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("dbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000000010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACH_at_Rn_dec, .name = "sts.l MACH,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("mach"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000010010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACL_at_Rn_dec, .name = "sts.l MACL,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("macl"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000100010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_PR_atRn_dec, .name = "sts.l PR,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("pr"), .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
