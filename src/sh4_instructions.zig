...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    .{ .code = 0b0110000000000000, .mask = 0b0000111111110000, .fn_ = interpreter.movb_atRm_Rn, .name = "mov.b @Rm,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .jit_emit_fn = sh4_jit.movb_atRm_Rn, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0110000000000001, .mask = 0b0000111111110000, .fn_ = interpreter.movw_atRm_Rn, .name = "mov.w @Rm,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .jit_emit_fn = sh4_jit.movw_atRm_Rn, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0110000000000010, .mask = 0b0000111111110000, .fn_ = interpreter.movl_atRm_Rn, .name = "mov.l @Rm,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .jit_emit_fn = sh4_jit.movl_atRm_Rn },
    .{ .code = 0b0010000000000000, .mask = 0b0000111111110000, .fn_ = interpreter.movb_Rm_atRn, .name = "mov.b Rm,@Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movb_Rm_atRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{} } },
    .{ .code = 0b0010000000000001, .mask = 0b0000111111110000, .fn_ = interpreter.movw_Rm_atRn, .name = "mov.w Rm,@Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movw_Rm_atRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{} } },
    .{ .code = 0b0010000000000010, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atRn, .name = "mov.l Rm,@Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movl_Rm_atRn },
    .{ .code = 0b0110000000000100, .mask = 0b0000111111110000, .fn_ = interpreter.movb_atRmInc_Rn, .name = "mov.b @Rm+,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movb_atRmInc_Rn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true, .rm = true } } }, // TODO: or 2
    .{ .code = 0b0110000000000101, .mask = 0b0000111111110000, .fn_ = interpreter.movw_atRmInc_Rn, .name = "mov.w @Rm+,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movw_atRmInc_Rn }, // TODO: or 2
    .{ .code = 0b0110000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_atRmInc_Rn, .name = "mov.l @Rm+,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movl_atRmInc_Rn }, // TODO: or 2
    .{ .code = 0b0010000000000100, .mask = 0b0000111111110000, .fn_ = interpreter.movb_Rm_atRnDec, .name = "mov.b Rm,@-Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movb_Rm_atRnDec, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0010000000000101, .mask = 0b0000111111110000, .fn_ = interpreter.movw_Rm_atRnDec, .name = "mov.w Rm,@-Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movw_Rm_atRnDec, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0010000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atRnDec, .name = "mov.l Rm,@-Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movl_Rm_atRnDec },
    .{ .code = 0b1000010000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movb_atDispRm_R0, .name = "mov.b @(disp,Rm),R0", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .jit_emit_fn = sh4_jit.movb_atDispRm_R0, .access = .{ .r = .{ .rm = true }, .w = .{ .r0 = true } } },
    .{ .code = 0b1000010100000000, .mask = 0b0000000011111111, .fn_ = interpreter.movw_atDispRm_R0, .name = "mov.w @(disp,Rm),R0", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .jit_emit_fn = sh4_jit.movw_atDispRm_R0, .access = .{ .r = .{ .rm = true }, .w = .{ .r0 = true } } },
    .{ .code = 0b0101000000000000, .mask = 0b0000111111111111, .fn_ = interpreter.movl_atDispRm_Rn, .name = "mov.l @(disp,Rm),Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .jit_emit_fn = sh4_jit.movl_atDispRm_Rn },
    .{ .code = 0b1000000000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movb_R0_atDispRm, .name = "mov.b R0,@(disp,Rm)", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movb_R0_atDispRm, .access = .{ .r = .{ .r0 = true, .rm = true }, .w = .{} } },
    .{ .code = 0b1000000100000000, .mask = 0b0000000011111111, .fn_ = interpreter.movw_R0_atDispRm, .name = "mov.w R0,@(disp,Rm)", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movw_R0_atDispRm, .access = .{ .r = .{ .r0 = true, .rm = true }, .w = .{} } },
    .{ .code = 0b0001000000000000, .mask = 0b0000111111111111, .fn_ = interpreter.movl_Rm_atDispRn, .name = "mov.l Rm,@(disp,Rn)", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movl_Rm_atDispRn },
    ...
    .{ .code = 0b1100010000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movb_atDispGBR_R0, .name = "mov.b @(d:8,GBR),R0", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .access = .{ .r = .{}, .w = .{ .r0 = true } } },
    .{ .code = 0b1100010100000000, .mask = 0b0000000011111111, .fn_ = interpreter.movw_atDispGBR_R0, .name = "mov.w @(d:8,GBR),R0", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .access = .{ .r = .{}, .w = .{ .r0 = true } } },
    .{ .code = 0b1100011000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movl_atDispGBR_R0, .name = "mov.l @(d:8,GBR),R0", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .access = .{ .r = .{}, .w = .{ .r0 = true } } },
    .{ .code = 0b1100000000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movb_R0_atDispGBR, .name = "mov.b R0,@(d:8,GBR)", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b1100000100000000, .mask = 0b0000000011111111, .fn_ = interpreter.movw_R0_atDispGBR, .name = "mov.w R0,@(d:8,GBR)", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b1100001000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movl_R0_atDispGBR, .name = "mov.l R0,@(d:8,GBR)", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b0000000000101001, .mask = 0b0000111100000000, .fn_ = interpreter.movt_Rn, .name = "movt Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 1, .jit_emit_fn = sh4_jit.movt_Rn, .access = .{ .r = .{}, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0000000000001111, .mask = 0b0000111111110000, .fn_ = interpreter.macl_atRmInc_atRnInc, .name = "mac.l @Rm+,@Rn+", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true, .rm = true } } },
    .{ .code = 0b0100000000001111, .mask = 0b0000111111110000, .fn_ = interpreter.macw_atRmInc_atRnInc, .name = "mac.w @Rm+,@Rn+", .privileged = false, .issue_cycles = 2, .latency_cycles = 4, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true, .rm = true } } },
    ...
    .{ .code = 0b0110000000000111, .mask = 0b0000111111110000, .fn_ = interpreter.not_Rm_Rn, .name = "not Rm,Rn", .privileged = false, .jit_emit_fn = sh4_jit.not_Rm_Rn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b1100111100000000, .mask = 0b0000000011111111, .fn_ = interpreter.orb_imm_atR0GBR, .name = "or.b #imm,@(R0,GBR)", .privileged = false, .issue_cycles = 4, .latency_cycles = 4, .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b0100000000011011, .mask = 0b0000111100000000, .fn_ = interpreter.tasb_atRn, .name = "tas.b @Rn", .privileged = false, .issue_cycles = 5, .latency_cycles = 5, .access = .{ .r = .{ .rn = true }, .w = .{} } },
    ...
    .{ .code = 0b0100000000000100, .mask = 0b0000111100000000, .fn_ = interpreter.rotl_Rn, .name = "rotl Rn", .privileged = false, .jit_emit_fn = sh4_jit.rotl_Rn, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000000101, .mask = 0b0000111100000000, .fn_ = interpreter.rotr_Rn, .name = "rotr Rn", .privileged = false, .jit_emit_fn = sh4_jit.rotr_Rn, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000001101, .mask = 0b0000111111110000, .fn_ = interpreter.shld_Rm_Rn, .name = "shld Rm,Rn", .privileged = false, .jit_emit_fn = sh4_jit.shld_Rm_Rn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000011110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_GBR, .name = "ldc Rn,GBR", .privileged = false, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000010111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_atRnInc_GBR, .name = "ldc.l @Rn+,GBR", .privileged = false, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000101110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_VBR, .name = "ldc Rn,VBR", .privileged = true, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("vbr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000100111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_atRnInc_VBR, .name = "ldc.l @Rn+,VBR", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("vbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000111110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_SSR, .name = "ldc Rn,SSR", .privileged = true, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("ssr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000110111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_atRnInc_SSR, .name = "ldc.l @Rn+,SSR", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("ssr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000001001110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_SPC, .name = "ldc Rn,SPC", .privileged = true, .issue_cycles = 3, .latency_cycles = 1, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("spc"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000001000111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_atRnInc_SPC, .name = "ldc.l @Rn+,SPC", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("spc"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000011111010, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_DBR, .name = "ldc Rn,DBR", .privileged = true, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("dbr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000011110110, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_atRnInc_DBR, .name = "ldc.l @Rn+,DBR", .privileged = true, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("dbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000001010, .mask = 0b0000111100000000, .fn_ = interpreter.lds_Rn_MACH, .name = "lds Rn,MACH", .privileged = false, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("mach"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000000110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_MACH, .name = "lds.l @Rn+,MACH", .privileged = false, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("mach"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000011010, .mask = 0b0000111100000000, .fn_ = interpreter.lds_Rn_MACL, .name = "lds Rn,MACL", .privileged = false, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("macl"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000010110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_MACL, .name = "lds.l @Rn+,MACL", .privileged = false, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("macl"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000101010, .mask = 0b0000111100000000, .fn_ = interpreter.lds_Rn_PR, .name = "lds Rn,PR", .privileged = false, .issue_cycles = 2, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("pr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000100110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_PR, .name = "lds.l @Rn+,PR", .privileged = false, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("pr"), .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000000000011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SR_atRnDec, .name = "stc.l SR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("sr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000010010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_GBR_Rn, .name = "stc GBR,Rn", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("gbr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000010011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_GBR_atRnDec, .name = "stc.l GBR,@-Rn", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000100010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_VBR_Rn, .name = "stc VBR,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("vbr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000100011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_VBR_atRnDec, .name = "stc.l VBR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("vbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000111010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_SGR_rn, .name = "stc SGR,Rn", .privileged = true, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.stc_Reg_Rn("sgr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000110010, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SGR_atRnDec, .name = "stc.l SGR,@-Rn", .privileged = true, .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("sgr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000110010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_SSR_rn, .name = "stc SSR,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("ssr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000110011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SSR_atRnDec, .name = "stc.l SSR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("ssr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000001000010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_SPC_rn, .name = "stc SPC,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("spc"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000001000011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_SPC_atRnDec, .name = "stc.l SPC,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("spc"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000011111010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_DBR_rn, .name = "stc DBR,Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("dbr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000011110010, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_DBR_atRnDec, .name = "stc.l DBR,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("dbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000010000011, .mask = 0b0000111101110000, .fn_ = interpreter.stcl_Rm_BANK_atRnDec, .name = "stc.l Rm_BANK,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000001010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_MACH_Rn, .name = "sts MACH,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.stc_Reg_Rn("mach"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000000010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACH_atRnDec, .name = "sts.l MACH,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("mach"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000011010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_MACL_Rn, .name = "sts MACL,Rn", .privileged = false, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.stc_Reg_Rn("macl"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000010010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACL_atRnDec, .name = "sts.l MACL,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("macl"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000101010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_PR_Rn, .name = "sts PR,Rn", .privileged = false, .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("pr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000100010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_PR_atRnDec, .name = "sts.l PR,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("pr"), .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b1111000000001000, .mask = 0b0000111111110000, .fn_ = interpreter.fmovs_atRm_FRn, .name = "fmov.s @Rm,FRn", .privileged = false, .issue_cycles = 1, .latency_cycles = 2, .jit_emit_fn = sh4_jit.fmovs_atRm_FRn, .access = .{ .r = .{ .rm = true }, .w = .{} } },
    .{ .code = 0b1111000000001010, .mask = 0b0000111111110000, .fn_ = interpreter.fmovs_FRm_atRn, .name = "fmov.s FRm,@Rn", .privileged = false, .jit_emit_fn = sh4_jit.fmovs_FRm_atRn, .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b1111000000001001, .mask = 0b0000111111110000, .fn_ = interpreter.fmovs_atRmInc_FRn, .name = "fmov.s @Rm+,FRn", .privileged = false, .jit_emit_fn = sh4_jit.fmovs_atRmInc_FRn, .access = .{ .r = .{ .rm = true }, .w = .{ .rm = true } } },
    .{ .code = 0b1111000000001011, .mask = 0b0000111111110000, .fn_ = interpreter.fmovs_FRm_atDecRn, .name = "fmov.s FRm,@-Rn", .privileged = false, .jit_emit_fn = sh4_jit.fmovs_FRm_atDecRn, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b1111000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.fmovs_atR0Rm_FRn, .name = "fmov.s @(R0,Rm),FRn", .privileged = false, .issue_cycles = 1, .jit_emit_fn = sh4_jit.fmovs_atR0Rm_FRn, .latency_cycles = 2, .access = .{ .r = .{ .r0 = true, .rm = true }, .w = .{} } },
    .{ .code = 0b1111000000000111, .mask = 0b0000111111110000, .fn_ = interpreter.fmovs_FRm_atR0Rn, .name = "fmov.s FRm,@(R0,Rn)", .privileged = false, .jit_emit_fn = sh4_jit.fmovs_FRm_atR0Rn, .access = .{ .r = .{ .r0 = true, .rn = true }, .w = .{} } },
    ...
    .{ .code = 0b1111000001011101, .mask = 0b0000111100000000, .fn_ = interpreter.fabs_FRn, .name = "fabs FRn", .privileged = false, .issue_cycles = 1, .latency_cycles = 0, .jit_emit_fn = sh4_jit.fabs_FRn, .access = .{ .r = .{}, .w = .{} } },
    .{ .code = 0b1111000001001101, .mask = 0b0000111100000000, .fn_ = interpreter.fneg_FRn, .name = "fneg FRn", .privileged = false, .issue_cycles = 1, .latency_cycles = 0, .jit_emit_fn = sh4_jit.fneg_FRn, .access = .{ .r = .{}, .w = .{} } },
    ...
    .{ .code = 0b0100000001100110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_FPSCR, .name = "lds.l @Rn+,FPSCR", .privileged = false, .issue_cycles = 1, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldsl_atRnInc_FPSCR, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000001100010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_FPSCR_atRnDec, .name = "sts.l FPSCR,@-Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0100000001010110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_FPUL, .name = "lds.l @Rn+,FPUL", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000001010010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_FPUL_atRnDec, .name = "sts.l FPUL,@-Rn", .privileged = false, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
