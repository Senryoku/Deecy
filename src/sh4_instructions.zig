...
pub const Opcodes: [217]OpcodeDescription = .{
    ...
    .{ .code = 0b0010000000000000, .mask = 0b0000111111110000, .fn_ = interpreter.movb_Rm_atRn, .name = "mov.b Rm,@Rn", .jit_emit_fn = sh4_jit.movb_Rm_atRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{} } },
    .{ .code = 0b0010000000000001, .mask = 0b0000111111110000, .fn_ = interpreter.movw_Rm_atRn, .name = "mov.w Rm,@Rn", .jit_emit_fn = sh4_jit.movw_Rm_atRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{} } },
    .{ .code = 0b0010000000000010, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atRn, .name = "mov.l Rm,@Rn", .jit_emit_fn = sh4_jit.movl_Rm_atRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{} } },
    .{ .code = 0b0110000000000100, .mask = 0b0000111111110000, .fn_ = interpreter.movb_atRmInc_Rn, .name = "mov.b @Rm+,Rn", .jit_emit_fn = sh4_jit.movb_atRmInc_Rn, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true, .rm = true } } }, // TODO: or 2
    .{ .code = 0b0110000000000101, .mask = 0b0000111111110000, .fn_ = interpreter.movw_atRmInc_Rn, .name = "mov.w @Rm+,Rn", .jit_emit_fn = sh4_jit.movw_atRmInc_Rn, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true, .rm = true } } }, // TODO: or 2
    .{ .code = 0b0110000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_atRmInc_Rn, .name = "mov.l @Rm+,Rn", .jit_emit_fn = sh4_jit.movl_atRmInc_Rn, .access = .{ .r = .{ .rm = true }, .w = .{ .rn = true, .rm = true } } }, // TODO: or 2
    .{ .code = 0b0010000000000100, .mask = 0b0000111111110000, .fn_ = interpreter.movb_Rm_atDecRn, .name = "mov.b Rm,@-Rn", .jit_emit_fn = sh4_jit.movb_Rm_atDecRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0010000000000101, .mask = 0b0000111111110000, .fn_ = interpreter.movw_Rm_atDecRn, .name = "mov.w Rm,@-Rn", .jit_emit_fn = sh4_jit.movw_Rm_atDecRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0010000000000110, .mask = 0b0000111111110000, .fn_ = interpreter.movl_Rm_atDecRn, .name = "mov.l Rm,@-Rn", .jit_emit_fn = sh4_jit.movl_Rm_atDecRn, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b1100010000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movb_atDispGBR_R0, .name = "mov.b @(d:8,GBR),R0", .latency_cycles = 2, .access = .{ .r = .{}, .w = .{ .r0 = true } } },
    .{ .code = 0b1100010100000000, .mask = 0b0000000011111111, .fn_ = interpreter.movw_atDispGBR_R0, .name = "mov.w @(d:8,GBR),R0", .latency_cycles = 2, .access = .{ .r = .{}, .w = .{ .r0 = true } } },
    .{ .code = 0b1100011000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movl_atDispGBR_R0, .name = "mov.l @(d:8,GBR),R0", .latency_cycles = 2, .access = .{ .r = .{}, .w = .{ .r0 = true } } },
    .{ .code = 0b1100000000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movb_R0_atDispGBR, .name = "mov.b R0,@(d:8,GBR)", .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b1100000100000000, .mask = 0b0000000011111111, .fn_ = interpreter.movw_R0_atDispGBR, .name = "mov.w R0,@(d:8,GBR)", .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b1100001000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movl_R0_atDispGBR, .name = "mov.l R0,@(d:8,GBR)", .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    ...
    .{ .code = 0b0000000000001111, .mask = 0b0000111111110000, .fn_ = interpreter.macl_atRmInc_atRnInc, .name = "mac.l @Rm+,@Rn+", .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true, .rm = true } } },
    .{ .code = 0b0100000000001111, .mask = 0b0000111111110000, .fn_ = interpreter.macw_atRmInc_atRnInc, .name = "mac.w @Rm+,@Rn+", .issue_cycles = 2, .latency_cycles = 4, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{ .rn = true, .rm = true } } },
    ...
    .{ .code = 0b0010000000001111, .mask = 0b0000111111110000, .fn_ = interpreter.mulsw_Rm_Rn, .name = "muls.w Rm,Rn", .issue_cycles = 2, .latency_cycles = 4, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{} } },
    .{ .code = 0b0010000000001110, .mask = 0b0000111111110000, .fn_ = interpreter.muluw_Rm_Rn, .name = "mulu.w Rm,Rn", .issue_cycles = 2, .latency_cycles = 4, .access = .{ .r = .{ .rn = true, .rm = true }, .w = .{} } },
    ...
    .{ .code = 0b0100000000011110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_GBR, .name = "ldc Rn,GBR", .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000010111, .mask = 0b0000111100000000, .fn_ = interpreter.ldcl_atRnInc_GBR, .name = "ldc.l @Rn+,GBR", .issue_cycles = 3, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000101110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_VBR, .name = "ldc Rn,VBR", .privileged = true, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("vbr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    ...
    .{ .code = 0b0100000000111110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_SSR, .name = "ldc Rn,SSR", .privileged = true, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("ssr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    ...
    .{ .code = 0b0100000001001110, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_SPC, .name = "ldc Rn,SPC", .privileged = true, .issue_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("spc"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    ...
    .{ .code = 0b0100000011111010, .mask = 0b0000111100000000, .fn_ = interpreter.ldc_Rn_DBR, .name = "ldc Rn,DBR", .privileged = true, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("dbr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    ...
    .{ .code = 0b0100000000001010, .mask = 0b0000111100000000, .fn_ = interpreter.lds_Rn_MACH, .name = "lds Rn,MACH", .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("mach"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000000110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_MACH, .name = "lds.l @Rn+,MACH", .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("mach"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000011010, .mask = 0b0000111100000000, .fn_ = interpreter.lds_Rn_MACL, .name = "lds Rn,MACL", .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("macl"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000010110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_MACL, .name = "lds.l @Rn+,MACL", .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("macl"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000101010, .mask = 0b0000111100000000, .fn_ = interpreter.lds_Rn_PR, .name = "lds Rn,PR", .issue_cycles = 2, .latency_cycles = 3, .jit_emit_fn = sh4_jit.ldc_Rn_Reg("pr"), .access = .{ .r = .{ .rn = true }, .w = .{} } },
    .{ .code = 0b0100000000100110, .mask = 0b0000111100000000, .fn_ = interpreter.ldsl_atRnInc_PR, .name = "lds.l @Rn+,PR", .jit_emit_fn = sh4_jit.ldcl_atRnInc_Reg("pr"), .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0000000010010011, .mask = 0b0000111100000000, .fn_ = interpreter.ocbi_atRn, .name = "ocbi @Rn", .access = .{ .r = .{ .rn = true } } },
    .{ .code = 0b0000000010100011, .mask = 0b0000111100000000, .fn_ = interpreter.ocbp_atRn, .name = "ocbp @Rn", .access = .{ .r = .{ .rn = true } } },
    ...
    .{ .code = 0b0000000000010010, .mask = 0b0000111100000000, .fn_ = interpreter.stc_GBR_Rn, .name = "stc GBR,Rn", .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("gbr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000010011, .mask = 0b0000111100000000, .fn_ = interpreter.stcl_GBR_atRnDec, .name = "stc.l GBR,@-Rn", .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("gbr"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    ...
    .{ .code = 0b0000000000001010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_MACH_Rn, .name = "sts MACH,Rn", .latency_cycles = 3, .jit_emit_fn = sh4_jit.stc_Reg_Rn("mach"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000000010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACH_atRnDec, .name = "sts.l MACH,@-Rn", .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("mach"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000011010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_MACL_Rn, .name = "sts MACL,Rn", .latency_cycles = 3, .jit_emit_fn = sh4_jit.stc_Reg_Rn("macl"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000010010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_MACL_atRnDec, .name = "sts.l MACL,@-Rn", .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("macl"), .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
    .{ .code = 0b0000000000101010, .mask = 0b0000111100000000, .fn_ = interpreter.sts_PR_Rn, .name = "sts PR,Rn", .issue_cycles = 2, .latency_cycles = 2, .jit_emit_fn = sh4_jit.stc_Reg_Rn("pr"), .access = .{ .r = .{}, .w = .{ .rn = true } } },
    .{ .code = 0b0100000000100010, .mask = 0b0000111100000000, .fn_ = interpreter.stsl_PR_atRnDec, .name = "sts.l PR,@-Rn", .jit_emit_fn = sh4_jit.stcl_Reg_atRnDec("pr"), .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
