...
pub const Opcodes = [_]OpcodeDescription{
    ...
    .{ .code = 0b1100000000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movb_R0_atDispGBR, .name = "mov.b R0,@(d:8,GBR)", .jit_emit_fn = sh4_jit.movb_R0_atDispGBR, .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b1100000100000000, .mask = 0b0000000011111111, .fn_ = interpreter.movw_R0_atDispGBR, .name = "mov.w R0,@(d:8,GBR)", .jit_emit_fn = sh4_jit.movw_R0_atDispGBR, .access = .{ .r = .{ .r0 = true }, .w = .{} } },
    .{ .code = 0b1100001000000000, .mask = 0b0000000011111111, .fn_ = interpreter.movl_R0_atDispGBR, .name = "mov.l R0,@(d:8,GBR)", .jit_emit_fn = sh4_jit.movl_R0_atDispGBR, .access = .{ .r = .{ .r0 = true }, .w = .{} } },
