...
pub const Opcodes = [_]OpcodeDescription{
    ...
    .{ .code = 0b0100000010000011, .mask = 0b0000111101110000, .fn_ = interpreter.stcl_Rm_BANK_atDecRn, .name = "stc.l Rm_BANK,@-Rn", .privileged = true, .issue_cycles = 2, .latency_cycles = 2, .access = .{ .r = .{ .rn = true }, .w = .{ .rn = true } } },
