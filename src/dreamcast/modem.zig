...
//!
//! Stub implementation. Only the basic initialization is implemented.
//! This is also not currently serialized: Until is it functional, it is not
//! worth breaking compatibility.
...
const CountryCode = enum(u8) { Reserved = 0, Japan = 1, USA = 2, _ };
const DeviceType = enum(u4) { @"33.6Kbps" = 0, _ };
const MakerCode = enum(u4) { SEGA = 0, Rockwell = 1, _ };
