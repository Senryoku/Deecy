...
fn copy_flatpak_files(b: *std.Build) void {
    ...
    const desktop_contents = b.fmt(
        ...
        \\Exec=Deecy
        \\Icon=io.github.Senryoku.Deecy
        \\Terminal=false
        \\Categories=Game;Emulator;
        \\Keywords=dreamcast;emulator;
    , .{ version.major, version.minor, version.patch });

    const write_files = b.addWriteFiles();
    const desktop_file = write_files.add("io.github.Senryoku.Deecy.desktop", desktop_contents);
